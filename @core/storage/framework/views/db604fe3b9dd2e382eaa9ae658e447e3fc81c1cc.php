                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.scripts.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_google_map_api"><?php echo e(__('Google Map API')); ?></label>
                                <input type="text" name="site_google_map_api"  class="form-control" value="<?php echo e(get_static_option('site_google_map_api')); ?>" id="site_google_map_api">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/rtl/@core/resources/views/backend/general-settings/thid-party.blade.php ENDPATH**/ ?>