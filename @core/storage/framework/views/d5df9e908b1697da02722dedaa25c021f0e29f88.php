<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Call Back Form Builder')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Call Back Form Builder")); ?></h4>
                        <form action="<?php echo e(route('admin.form.builder.call.back')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/backend/form-builder/call-back-form.blade.php ENDPATH**/ ?>