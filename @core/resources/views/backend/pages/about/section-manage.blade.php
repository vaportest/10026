                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.about.page.section.manage')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="about_page_know_about_section_status"><strong>{{__('Know About Us Section Show/Hide')}}</strong></label>
                                        <label class="switch">
                                            <input type="checkbox" name="about_page_know_about_section_status"  @if(!empty(get_static_option('about_page_know_about_section_status'))) checked @endif id="about_page_know_about_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="about_page_call_to_action_section_status"><strong>{{__('Call To Action Section Show/Hide')}}</strong></label>
                                        <label class="switch">
                                            <input type="checkbox" name="about_page_call_to_action_section_status"  @if(!empty(get_static_option('about_page_call_to_action_section_status'))) checked @endif id="about_page_call_to_action_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
