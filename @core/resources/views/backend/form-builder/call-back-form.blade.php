                                        ...
                                        <div class="collapse" id="fileds_collapse_{{$key}}">
                                            <div class="card card-body margin-top-30">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="field-required" name="field_required[{{$key}}]"
                                                               @if(is_object($form_fields->field_required) && !empty($form_fields->field_required->$key))
                                                               checked
                                                               @elseif(is_array($form_fields->field_required) && !empty($form_fields->field_required[$key]))
                                                               checked
                                                               @endif
                                                        >
                                                ...
                                                @if($value == 'select')
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="select_options[]"
                                                                  ...
                                                                  rows="10"
                                                                  placeholder="" required>{{$form_fields->select_options[$select_index]}}</textarea>
                                                ...
                                                @if($value == 'file')
                                                    <div class="form-group">
                                                        ...
                                                        <select name="mimes_type[{{$key}}]" class="form-control mime-type">
