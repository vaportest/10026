                        ...
                        <form action="<?php echo e(route('admin.homeone.service.area')); ?>" method="post"
                            ...
                            <div class="img-wrapper">
                                <?php if(file_exists('assets/uploads/'.get_static_option('home_page_01_service_area_background_image'))): ?>
                                    <img  style="max-width: 200px; margin-top:20px;" src="<?php echo e(asset('assets/uploads/'.get_static_option('home_page_01_service_area_background_image'))); ?>" alt="">
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                            <div class="form-group">
                                ...
                                <small><?php echo e(__('recommended image size is 1920x800 pixel')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/backend/pages/home/home-01/service-area.blade.php ENDPATH**/ ?>