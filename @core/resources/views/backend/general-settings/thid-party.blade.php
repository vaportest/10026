                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.scripts.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_google_map_api">{{__('Google Map API')}}</label>
                                <input type="text" name="site_google_map_api"  class="form-control" value="{{get_static_option('site_google_map_api')}}" id="site_google_map_api">
                            </div>
                            <div class="form-group">
