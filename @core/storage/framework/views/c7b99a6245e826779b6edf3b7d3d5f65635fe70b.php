                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(file_exists('assets/uploads/key-feature/key-feature-pic-'.$data->id.'.'.$data->image)): ?>
                                                        <img style="max-width: 80px" src="<?php echo e(asset('assets/uploads/key-feature/key-feature-pic-'.$data->id.'.'.$data->image)); ?>" alt="<?php echo e(__($data->name)); ?>">
                                                        <?php $img_url = asset('assets/uploads/key-feature/key-feature-pic-'.$data->id.'.'.$data->image) ?>
                                                    <?php else: ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/backend/pages/key-features.blade.php ENDPATH**/ ?>