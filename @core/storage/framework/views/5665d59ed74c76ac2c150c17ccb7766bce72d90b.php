                        ...
                        <form action="<?php echo e(route('admin.contact.page.form.area')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="myTabContent">
                                ...
                                <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="home-<?php echo e($lang->slug); ?>" role="tabpanel" >
                                    ...
                                    <div class="form-group">
                                        <label for="contact_page_<?php echo e($lang->slug); ?>_form_section_description"><?php echo e(__('Description')); ?></label>
                                        <textarea name="contact_page_<?php echo e($lang->slug); ?>_form_section_description" id="contact_page_<?php echo e($lang->slug); ?>_form_section_description" class="form-control max-height-120" cols="30" rows="10"><?php echo e(get_static_option('contact_page_'.$lang->slug.'_form_section_description')); ?></textarea>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/rtl/@core/resources/views/backend/pages/contact-page/form-section.blade.php ENDPATH**/ ?>