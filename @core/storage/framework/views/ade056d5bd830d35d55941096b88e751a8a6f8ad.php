                        ...
                        <form action="<?php echo e(route('admin.homeone.faq.area')); ?>" method="post"
                            ...
                            <div class="img-wrapper">
                                <?php if(file_exists('assets/uploads/'.get_static_option('home_page_01_faq_area_background_image'))): ?>
                                    <img  style="max-width: 200px; margin-top:20px;" src="<?php echo e(asset('assets/uploads/'.get_static_option('home_page_01_faq_area_background_image'))); ?>" alt="">
                                <?php endif; ?>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/backend/pages/home/home-01/faq-area.blade.php ENDPATH**/ ?>