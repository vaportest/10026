...
<head>
    ...
    <title><?php echo e(__('Request Quote From ').get_static_option('site_title')); ?></title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
...
<body>
    <div class="mail-container">
        ...
        <p><?php echo e(__('You Have A Quote From '. get_static_option('site_title'))); ?></p>
        <table>
...
</html><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/mail/request-quote.blade.php ENDPATH**/ ?>