...
<head>
    ...
    <title><?php echo e(__('Contact Mail')); ?></title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
...
<body>
    <div class="mail-container">
        ...
        <p><?php echo e(__('You Have Contact Message From '. get_static_option('site_title'))); ?></p>
        <table>
...
</html><?php /**PATH /opt/lampp/htdocs/bizzcox/@core/resources/views/mail/contact.blade.php ENDPATH**/ ?>